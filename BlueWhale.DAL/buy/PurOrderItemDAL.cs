...
{
    public class PurOrderItemDAL
    {
        public PurOrderItemDAL()
        {
        ...
        public int Add()
        {
            ...
            string sql = @" insert into purOrderItem
                            ( 
                            pId
                            ,goodsId
                            ,num
        ...
        public int Delete(int PId)
        {
            ...
            sql += " delete from purOrderItem  where pId='" + PId + "' ";
        ...
        {
            string sql = "select * from viewPurOrderItem where pId='" + pId + "' ";
