...
namespace BlueWhale.DAL.produce
{
    ...
    public partial class goodsBomList
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.produce.goodsBomList model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.produce.goodsBomList model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.produce.goodsBomList GetModel(int id)
		{
			...
			goodsBomList model=new goodsBomList();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.produce.goodsBomList DataRowToModel(DataRow row)
		{
