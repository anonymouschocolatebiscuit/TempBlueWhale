...
namespace LanweiBLL
{
    ...
    public partial class user_amount_log
    {
        ...
        private readonly Lanwei.Weixin.DAL.user_amount_log dal;
        public user_amount_log()
        {
            dal = new Lanwei.Weixin.DAL.user_amount_log(siteConfig.sysdatabaseprefix);
        }
        #region  Method
        /// <summary>
        /// 是否存在该记录
        ...
        {
            Lanwei.Weixin.Model.user_amount_log model = new Lanwei.Weixin.Model.user_amount_log();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Lanwei.Weixin.Model.user_amount_log model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Lanwei.Weixin.Model.user_amount_log GetModel(int id)
        {
        ...
        /// 根据订单号返回一个实体
        /// </summary>
        public Lanwei.Weixin.Model.user_amount_log GetModel(string order_no)
        {
