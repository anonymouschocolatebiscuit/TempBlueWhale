...
namespace LanweiBLL
{
	...
	public partial class navigation
	{
        ...
        private readonly Lanwei.Weixin.DAL.navigation dal;
		public navigation()
		{
            dal = new Lanwei.Weixin.DAL.navigation(siteConfig.sysdatabaseprefix);
        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Lanwei.Weixin.Model.navigation GetModel(string name)
        {
