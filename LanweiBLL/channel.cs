    ...
    public partial class channel
    {
        ...
        public int Add(Lanwei.Weixin.Model.channel model)
        {
            ...
            if (channelId > 0)
            {
                ...
                //添加子导航菜单
                new LanweiBLL.navigation().Add("channel_" + model.name, "channel_" + model.name + "_list", "内容管理", "article/article_list.aspx", 99, channelId, "Show,View,Add,Edit,Delete,Audit");
                new LanweiBLL.navigation().Add("channel_" + model.name, "channel_" + model.name + "_category", "栏目类别", "article/category_list.aspx", 100, channelId, "Show,View,Add,Edit,Delete");
                new LanweiBLL.navigation().Add("channel_" + model.name, "channel_" + model.name + "_comment", "评论管理", "article/comment_list.aspx", 101, channelId, "Show,View,Delete,Reply");
            }
            return channelId;
        }
