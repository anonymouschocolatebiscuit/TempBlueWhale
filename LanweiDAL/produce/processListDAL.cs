...
namespace Lanwei.Weixin.DAL
{
    public class processListDAL
    {
        ...
        public bool CheckBeUsed(int id)
        {
            ...
            string sql = "select * from processList where typeId='" + id + "' ";
        ...
        public int Add()
        {
            string sql = "insert into processList(shopId,typeId,names,unitId,price,seq) values('" + ShopId + "','"+TypeId+"','" + Names + "','"+UnitId+"','"+Price+"','" + Seq + "')";
        ...
        public int Update()
        {
            ...
            {
                sql = "update processList set ShopId='" + ShopId + "',TypeId='" + TypeId + "',Names='" + Names + "',unitId='" + UnitId + "',price='" + Price + "',Seq='" + Seq + "' where Id='" + Id + "'";
        ...
        {
            string sql = "select * from processList where Id='" + Id + "'";
