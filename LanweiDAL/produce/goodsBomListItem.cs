...
namespace Lanwei.Weixin.DAL
{
	...
	public partial class goodsBomListItem
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Lanwei.Weixin.Model.goodsBomListItem model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Lanwei.Weixin.Model.goodsBomListItem model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Lanwei.Weixin.Model.goodsBomListItem GetModel(int id)
		{
			...
			Lanwei.Weixin.Model.goodsBomListItem model=new Lanwei.Weixin.Model.goodsBomListItem();
		...
		/// 得到一个对象实体
		/// </summary>
		public Lanwei.Weixin.Model.goodsBomListItem DataRowToModel(DataRow row)
		{
			Lanwei.Weixin.Model.goodsBomListItem model=new Lanwei.Weixin.Model.goodsBomListItem();
			if (row != null)
			{
