...
{
    public class CheckBillItemSalesDAL
    {
        public CheckBillItemSalesDAL()
        {
        ...
        public int Add()
        {
            ...
            string sql = "insert into CheckBillItemSales(pId,sourceNumber,priceCheckNow,flag)";
        ...
        public int Delete(int PId)
        {
            ...
            sql += " delete from CheckBillItemSales  where pId='" + PId + "' ";
        ...
        {
            string sql = "select * from viewCheckBillItemSales where pId='" + pId + "' ";
