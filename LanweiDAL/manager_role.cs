...
namespace LanweiDAL
{
    ...
    public partial class manager_role
    {
        ...
        public int Add(LanweiModel.manager_role model)
        {
            ...
            {
                foreach (LanweiModel.manager_role_value modelt in model.manager_role_values)
                {
        ...
        public LanweiModel.manager_role GetModel(int id)
        {
            ...
            LanweiModel.manager_role model = new LanweiModel.manager_role();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    List<LanweiModel.manager_role_value> models = new List<LanweiModel.manager_role_value>();
                    LanweiModel.manager_role_value modelt;
                    foreach (DataRow dr in ds2.Tables[0].Rows)
                    {
                        modelt = new LanweiModel.manager_role_value();
                        if (dr["id"].ToString() != "")
                        {
