    ...
    public class PurReceiptDAL
    {
        ...
        public string GetBillNumberAuto(int shopId)
        {
            ...
            SqlParameter[] param = {
                                       ...
                                       new SqlParameter("@NumberHeader","CGRK"),//单据代码前四位字母
                                       new SqlParameter("@tableName","purReceipt")//表
        ...
        {
            string sql = "select * from viewPurReceipt order by number ";
        ...
        {
            string sql = "select * from viewPurReceipt where number='" + number + "' order by number ";
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM viewPurReceipt ");
            if (strWhere.Trim() != "")
            {
        ...
        /// <returns></returns>
        public DataSet GetPurReceiptItemDetailBack(DateTime start,DateTime end,int ckId,int wlId,int goodsId)
        {
        ...
        /// <param name="goodsId"></param>
        /// <returns></returns>
        public DataSet GetPurReceiptItemSumGoodsBack(DateTime start, DateTime end, int ckId, int wlId, int goodsId)
        {
            string sql = "select goodsId,code,goodsName,spec,unitName,ckId,ckName,sum(num) sumNum,sum(sumPriceAll) sumPriceAll from viewPurReceiptDetail where bizDate<=@end and bizDate >=@start ";
            if (ckId != 0)
            {
                sql += " and ckId ='" + ckId + "' ";
            }
        ...
        /// <param name="goodsId"></param>
        /// <returns></returns>
        public DataSet GetPurReceiptItemSumVender(int shopId,DateTime start, DateTime end, int ckId, int wlId, int goodsId)
        {
            string sql = "select wlId,wlName,goodsId,code,goodsName,spec,unitName,ckId,ckName,sum(num) sumNum,sum(sumPrice) sumPrice from viewPurReceiptDetail where bizDate<=@end and bizDate >=@start ";
        ...
        /// <returns></returns>
        public DataSet getPurSumByMoth(int year)
        {
            string sql = @"select 
                                year(bizDate) years,
                                months,
                                ...
                                from months a
                                left join viewPurReceipt b on a.months=month(bizDate) and year(bizDate)=@year

                                group by year(bizDate),months";
