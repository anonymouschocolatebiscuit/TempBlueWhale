...
{
    public class PurTicketItemDAL
    {
        public PurTicketItemDAL()
        {
        ...
        public int Add()
        {
            ...
            string sql = "insert into PurTicketItem(pId,goodsId,num,price,dis,disPrice,sumPrice,tax,taxPrice,sumPriceAll,ckId,remarks,sourceNumber)";
        ...
        public int Delete(int PId)
        {
            ...
            sql += " delete from PurTicketItem  where pId='" + PId + "' ";
        ...
        {
            string sql = "select * from viewPurTicketItem where pId='" + pId + "' ";
