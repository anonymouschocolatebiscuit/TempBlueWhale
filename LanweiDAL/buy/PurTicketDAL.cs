    ...
    public class PurTicketDAL 
    {
        ...
        public string GetBillNumberAuto()
        {
            ...
            SqlParameter[] param = {
                                       ...
                                       new SqlParameter("@NumberHeader","CGFP"),//单据代码前四位字母
                                       new SqlParameter("@tableName","purTicket")//表
        ...
        public int Add()
        {
            ...
            string sql = "insert into purTicket(number,wlId,bizDate,types,remarks,dis,disPrice,sumPrice,payNow,payNowNo,bkId,makeId,makeDate,bizId,flag,billNo,imagePath)";
        ...
        public int Delete(int Id)
        {
            ...
            sql += "               select * from purTicket where flag='审核' and id='" + Id + "' )";

            sql += " begin ";

            sql += " delete from purTicketItem  where pId='" + Id + "' delete from purTicket where Id='" + Id + "'";
        ...
        {
            string sql = "select * from viewPurTicket order by number ";
        ...
        {
            string sql = "select * from viewPurTicket  where bizDate>=@start and bizDate<=@end  ";
            if (key != "")
            {
        ...
        {
            string sql = "select * from viewPurTicket  where bizDate>=@start and bizDate<=@end and wlId='" + venderId + "' and flag='审核' and (isnull(sumPriceAll,0)-isnull(priceCheckNowSum,0))> 0 ";
            if (key != "")
            {
        ...
        {
            string sql = "select * from viewPurTicket where id='" + id + "' order by number ";
        ...
        {
            string sql = "select * from viewPurTicket where number='" + number + "' order by number ";
        ...
        {
            string sql = " if not exists(select * from PurTicket where flag='" + flag + "' and id='" + Id + "') ";
            sql += " begin ";

            sql += " update PurTicket set flag='" + flag + "' ";
            if (flag == "审核")
            {
