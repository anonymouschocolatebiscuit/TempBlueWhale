...
namespace Lanwei.Weixin.DAL
{
    ...
    public partial class article_comment
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Lanwei.Weixin.Model.article_comment model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Lanwei.Weixin.Model.article_comment model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Lanwei.Weixin.Model.article_comment GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Lanwei.Weixin.Model.article_comment model = new Lanwei.Weixin.Model.article_comment();
