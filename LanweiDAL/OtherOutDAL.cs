    ...
    public class OtherOutDAL
    {
        ...
        public string GetBillNumberAuto(int shopId)
        {
            ...
            SqlParameter[] param = {
                                       ...
                                       new SqlParameter("@NumberHeader","QTCK"),//单据代码前四位字母
                                       new SqlParameter("@tableName","OtherOut")//表
        ...
        public int Delete(int Id)
        {
            ...
            sql += "               select * from OtherOut where flag='审核' and id='" + Id + "' )";
        ...
        {
            string sql = "select * from viewOtherOut order by number ";
        ...
        {
            string sql = "select * from viewOtherOut where id='"+id+"' order by number ";
        ...
        {
            string sql = "select * from viewOtherOut where number='" + number + "' order by number ";
