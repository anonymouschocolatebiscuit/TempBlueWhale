...
namespace Lanwei.Weixin.DAL
{
	...
	public partial class wx_userweixin
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Lanwei.Weixin.Model.wx_userweixin model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Lanwei.Weixin.Model.wx_userweixin model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Lanwei.Weixin.Model.wx_userweixin GetModel(int id)
		{
			...
			Lanwei.Weixin.Model.wx_userweixin model=new Lanwei.Weixin.Model.wx_userweixin();
		...
		/// 得到一个对象实体
		/// </summary>
		public Lanwei.Weixin.Model.wx_userweixin DataRowToModel(DataRow row)
		{
			Lanwei.Weixin.Model.wx_userweixin model=new Lanwei.Weixin.Model.wx_userweixin();
			if (row != null)
			{
