...
namespace Lanwei.Weixin.DAL
{
    ...
    public partial class wx_requestRule
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Lanwei.Weixin.Model.wx_requestRule model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Lanwei.Weixin.Model.wx_requestRule model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Lanwei.Weixin.Model.wx_requestRule GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Lanwei.Weixin.Model.wx_requestRule model = new Lanwei.Weixin.Model.wx_requestRule();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Lanwei.Weixin.Model.wx_requestRule DataRowToModel(DataRow row)
        {
            Lanwei.Weixin.Model.wx_requestRule model = new Lanwei.Weixin.Model.wx_requestRule();
            if (row != null)
            {
        ...
        public Lanwei.Weixin.Model.wx_requestRule GetSubscricModel(int wid)
        {
        ...
        /// <returns></returns>
        public Lanwei.Weixin.Model.wx_requestRule GetTop1Model(int wid, string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,wId,uId,ruleName,reqKeywords,reqestType,responseType,isDefault,modelFunctionName,modelFunctionId,seq,createDate,agentUrl,agentToken,isLikeSearch,extInt,extInt2,extStr,extStr2,extStr3,extStr4 from wx_requestRule ");
