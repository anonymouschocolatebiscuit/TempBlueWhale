...
namespace Lanwei.Weixin.DAL
{
	...
	public partial class wx_requestRuleContent
	{
		...
		/// 增加一条数据
		/// </summary>
        public int Add(Lanwei.Weixin.Model.wx_requestRuleContent model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
        public bool Update(Lanwei.Weixin.Model.wx_requestRuleContent model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
        public Lanwei.Weixin.Model.wx_requestRuleContent GetModel(int id)
		{
			...
			Lanwei.Weixin.Model.wx_requestRuleContent model=new Lanwei.Weixin.Model.wx_requestRuleContent();
		...
		/// 得到一个对象实体
		/// </summary>
        public Lanwei.Weixin.Model.wx_requestRuleContent DataRowToModel(DataRow row)
		{
            Lanwei.Weixin.Model.wx_requestRuleContent model = new Lanwei.Weixin.Model.wx_requestRuleContent();
			if (row != null)
			{
        ...
        /// <param name="rid">规则主键Id</param>
        /// <returns></returns>
        public Lanwei.Weixin.Model.wx_requestRuleContent GetMusicContent(int rid)
        {
        ...
        /// <param name="rid">规则主键Id</param>
        /// <returns></returns>
        public IList<Lanwei.Weixin.Model.wx_requestRuleContent> GetTuWenContent(int rid)
        {
            IList<Lanwei.Weixin.Model.wx_requestRuleContent> rcList = new List<Lanwei.Weixin.Model.wx_requestRuleContent>();
            ...
            while (sr.Read())
            {
                model = new Lanwei.Weixin.Model.wx_requestRuleContent();
                model.rContent = sr["rContent"].ToString();
                model.rContent2 = sr["rContent2"].ToString();
