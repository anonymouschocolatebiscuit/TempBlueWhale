...
namespace Lanwei.Weixin.DAL
{
    ...
    public partial class article_attach
    {
        ...
        /// </summary>
        public void DeleteList(SqlConnection conn, SqlTransaction trans, List<Lanwei.Weixin.Model.article_attach> models, int article_id)
        {
            StringBuilder idList = new StringBuilder();
            if (models != null)
            {
                foreach (Lanwei.Weixin.Model.article_attach modelt in models)
                {
                    if (modelt.id > 0)
                    {
        ...
        /// 删除附件文件
        /// </summary>
        public void DeleteFile(List<Lanwei.Weixin.Model.article_attach> models)
        {
            if (models != null)
            {
                foreach (Lanwei.Weixin.Model.article_attach modelt in models)
        ...
        /// 得到一个对象实体
        /// </summary>
        public Lanwei.Weixin.Model.article_attach GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Lanwei.Weixin.Model.article_attach model = new Lanwei.Weixin.Model.article_attach();
        ...
        /// 获得数据列表
        /// </summary>
        public List<Lanwei.Weixin.Model.article_attach> GetList(int article_id)
        {
            List<Lanwei.Weixin.Model.article_attach> modelList = new List<Lanwei.Weixin.Model.article_attach>();
            ...
            if (rowsCount > 0)
            {
                Lanwei.Weixin.Model.article_attach model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Lanwei.Weixin.Model.article_attach();
