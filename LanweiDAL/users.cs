...
namespace LanweiDAL
{
    ...
    public partial class users
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(LanweiModel.users model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(LanweiModel.users model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        {
            //获取用户旧数据
            LanweiModel.users model = GetModel(id);
            if (model == null)
            {
                return false;
            }
        ...
        /// 得到一个对象实体
        /// </summary>
        public LanweiModel.users GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            LanweiModel.users model = new LanweiModel.users();
        ...
        /// 根据用户名密码返回一个实体
        /// </summary>
        public LanweiModel.users GetModel(string user_name, string password, int emaillogin, int mobilelogin)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 根据用户名返回一个实体
        /// </summary>
        public LanweiModel.users GetModel(string user_name)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int InsertUserByWX(int wid,string openId, string tel, string username, string sex, out decimal cardno)
        {
            ...
            else
            {
                ...
                //IList<LanweiModel.wx_UCard_Sys> ucardSys = ucardSysBll.GetModelList("1=1 order by id desc");
                //if (ucardSys != null)
                //{
            ...
            cardno = MaxCard;
            LanweiModel.users user = new LanweiModel.users();
            user.isweixin = 1;
            user.group_id = 3;
        ...
        public bool EidtUserByWX(string id, string tel, string username, string sex, DateTime birthday)
        {
            ...
            LanweiModel.users user = GetModel(int.Parse(id));
            user.user_name = username;
            user.telphone = tel;
            user.email = "test@weixin.com";
