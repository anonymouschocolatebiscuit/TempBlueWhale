<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisassembleList.aspx.cs" Inherits="Lanwei.Weixin.UI.store.DisassembleList" %>
...
<body style=" padding-top:10px; padding-left:10px;">
 ...
 <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:30px;">
           ...
           <td style="text-align:left; width:180px;">
               ...
               <asp:TextBox ID="txtKeys" runat="server" nullText="请输单据号/组合商品/备注"></asp:TextBox>
