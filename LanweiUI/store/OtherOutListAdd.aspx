<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherOutListAdd.aspx.cs" Inherits="Lanwei.Weixin.UI.store.OtherOutListAdd" %>
...
<head runat="server">
   ...
   <%--  <script src="../lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script>--%>
    ...
    <script src="../lib/json2.js" type="text/javascript"></script>
     ...
     <script src="js/OtherOutListAdd.js" type="text/javascript"></script>
