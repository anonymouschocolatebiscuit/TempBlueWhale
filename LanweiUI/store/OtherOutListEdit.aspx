<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherOutListEdit.aspx.cs" Inherits="Lanwei.Weixin.UI.store.OtherOutListEdit" %>
...
<head runat="server">
   ...
   <link href="../lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
    ...
    <script src="../lib/json2.js" type="text/javascript"></script>
     ...
     <script src="js/OtherOutListEdit.js" type="text/javascript"></script>
 ...
 <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
    ...
    <asp:DropDownList ID="ddlVenderList" runat="server" Width="250px">
           ...
           <td style="text-align:left;">
                   ...
                   Text="其他出库" />
               <asp:RadioButton ID="rb2" runat="server" GroupName="t" Text="盘亏出库" />
               </td>
           </tr>
           </table>
