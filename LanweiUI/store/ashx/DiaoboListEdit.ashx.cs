...
namespace Lanwei.Weixin.UI.store.ashx
{
    ...
    public class DiaoboListEdit : IHttpHandler, IRequiresSessionState  //用Session必须引用IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!basePage.CheckPower("DiaoboListEdit"))
            {
            ...
            if (pId > 0)
            {
                ...
                DiaoboItemDAL item = new DiaoboItemDAL();
