...
namespace Lanwei.Weixin.UI.store.ashx
{
    ...
    public class OtherOutListAdd : IHttpHandler, IRequiresSessionState  //用Session必须引用IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!basePage.CheckPower("OtherOutListAdd"))
            {
            ...
            if (pId > 0)
            {
                ...
                if (check > 0)
                {
                    ...
                    logs.Events = "新增其他出库单：" + dal.Number;
