        ...
        $(function ()
        {
          ...
          var form = $("#form").ligerForm();
            ...
            manager = $("#maingrid").ligerGrid({
                ...
                { display: '入库单价', name: 'price', width: 100, type: 'float', align: 'right', editor: { type: 'float', precision: 4 }
               ...
               url: 'OtherInListEdit.aspx?Action=GetData&id='+getUrlParam("id"),//获取参数
