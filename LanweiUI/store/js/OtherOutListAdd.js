        ...
        $(function ()
        {
          ...
          var form = $("#form").ligerForm();
            ...
            manager = $("#maingrid").ligerGrid({
                ...
                { display: '出库单价', name: 'price', width: 100, type: 'float', align: 'right', editor: { type: 'float', precision: 4 }
                ...
                { display: '金额', name: 'sumPrice', width: 100, type: 'float', align: 'right',editor: { type: 'float' },
