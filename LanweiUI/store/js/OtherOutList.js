            ...
            checkbox: true,
                columns: [
                 ...
                 { display: '业务类别', name: 'types', width: 80, align: 'center' ,
                     ...
                     render: function (row) {  
                      var html = row.types == 1 ? "其他出库" : "<span style='color:green'>盘亏出库</span>";  
                      return html;
                     }   
                 ...
                 { display: '出库金额', name: 'sumPriceAll', width: 100, align: 'right',
      ...
      function add()
      {
         parent.f_addTab('OtherOutListAdd','其他出库-新增', 'store/OtherOutListAdd.aspx');
   ...
   // alert('buy/PurReceiptListAdd.aspx?id='+row.id);
     ...
     top.topManager.openPage({
      ...
      function editRow()
      {
          ...
          parent.f_addTab('OtherOutListEdit','其他出库-修改', 'store/OtherOutListEdit.aspx?id='+row.id);
      ...
      function viewRow()
      {
          ...
          parent.f_addTab('OtherOutListView','其他出库-详情', 'store/OtherOutListView.aspx?id='+row.id);
