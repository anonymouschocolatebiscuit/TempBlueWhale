           ...
           function editRow()
      {
          var row = manager.getSelectedRow();
           ...
           parent.f_addTab('DisassembleListEdit','商品拆卸单-修改', 'store/DisassembleListEdit.aspx?id='+row.id);
...
//          });
      ...
      function add()
      {
         ...
         parent.f_addTab('DisassembleListAdd','商品拆分-新增', 'store/DisassembleListAdd.aspx');
            ...
            manager = $("#maingrid").ligerGrid({
              checkbox: true,
               ...
               { display: '操作', isSort: false, width: 50, align: 'center', render: function(rowdata, rowindex, value) {
                 ...
                 { display: '拆分日期', name: 'bizDate', width: 70, align: 'center',valign:'center'},
                ...
                { display: '出库数量', name: 'num', width: 70, type: 'float', align: 'right' },
                ...
                { display: '出库仓库', name: 'ckId', width: 90, isSort: false,textField:'ckName',
                    editor: { type: 'select',
       ...
       var managersub;
        $(function ()
        {
            ...
            managersub = $("#maingridsub").ligerGrid({
                ...
                { display: '入库数量', name: 'num', width: 80, type: 'float', align: 'right',
