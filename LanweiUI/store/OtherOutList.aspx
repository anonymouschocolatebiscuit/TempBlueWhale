<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherOutList.aspx.cs" Inherits="Lanwei.Weixin.UI.store.OtherOutList" %>
...
<head runat="server">
    ...
    <script src="js/OtherOutList.js?v=2018.09.28" type="text/javascript"></script>
...
<body style="padding-left:10px; padding-top:10px;">
    ...
    <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:100%; line-height:40px;">
           ...
           <td style="text-align:left; width:180px;">
               ...
               <asp:TextBox ID="txtKeys" runat="server" nullText="请输单据号/供应商/备注"></asp:TextBox>
