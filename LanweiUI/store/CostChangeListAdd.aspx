<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostChangeListAdd.aspx.cs" Inherits="Lanwei.Weixin.UI.store.CostChangeListAdd" %>
...
<head runat="server">
   ...
   <link href="../lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
    ...
    <script src="../lib/json2.js" type="text/javascript"></script>
     ...
     <script src="js/CostChangeListAdd.js" type="text/javascript"></script>
