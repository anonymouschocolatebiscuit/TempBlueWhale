<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiaoboListAdd.aspx.cs" Inherits="Lanwei.Weixin.UI.store.DiaoboListAdd" %>
...
<head runat="server">
   ...
   <link href="../lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
    ...
    <script src="../lib/json2.js" type="text/javascript"></script>
     ...
     <script src="js/DiaoboListAdd.js" type="text/javascript"></script>
