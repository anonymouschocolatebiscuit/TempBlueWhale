...
{
    public partial class CostChangeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Params["Action"] == "GetDataList")
            {
                ...
                this.GetDataList(keys, bizStart, bizEnd, ckName, bizType);
                Response.End();
            }
        ...
        void GetDataList(string key, DateTime start, DateTime end, string ckName, string bizType)
        {

            DataSet ds = dal.GetAllModel(LoginUser.ShopId,key, start, end, ckName, bizType);
