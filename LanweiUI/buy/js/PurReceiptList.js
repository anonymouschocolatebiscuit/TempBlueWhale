           ...
           var menu = $.ligerMenu({ width: 120, items:
            ...
            checkbox: true,
                ...
                { display: '采购数量', name: 'sumNum', width: 100, align: 'right',
                 ...
                 { display: '采购金额', name: 'sumPriceAll', width: 100, align: 'right',
                 ...
                 { display: '已付款金额', name: 'priceCheckNowSum', width: 100, align: 'right',
                 ...
                 { display: '订单状态', name: 'flag', width: 60, align: 'center'},
      ...
      function add()
      {
           ...
           parent.f_addTab('PurReceiptListAdd','采购入库-新增','buy/PurReceiptListAdd.aspx?id=0');
             
//          top.topManager.openPage({
//            id : 'PurReceiptListAdd',
//            href : 'buy/PurReceiptListAdd.aspx?id=0',
//            title : '采购入库-新增'
//          });
      ...
      function editRow()
      {
          var row = manager.getSelectedRow();
           ...
           parent.f_addTab('PurReceiptListEdit','采购入库-修改','buy/PurReceiptListEdit.aspx?id='+row.id);
           
//          top.topManager.openPage({
//            id : 'PurReceiptListEdit',
//            href : 'buy/PurReceiptListEdit.aspx?id='+row.id,
//            title : '采购入库-修改'
//          });
      ...
      {
          var row = manager.getSelectedRow();
          parent.f_addTab('PurReceiptListEdit','采购入库-详情','buy/PurReceiptListEdit.aspx?id='+row.id);
