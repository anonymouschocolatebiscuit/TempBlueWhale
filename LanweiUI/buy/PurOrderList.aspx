<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurOrderList.aspx.cs" Inherits="Lanwei.Weixin.UI.buy.PurOrderList" %>
...
<head runat="server">
    ...
    <script src="../lib/json2.js" type="text/javascript"></script>
     ...
     <script src="js/PurOrderList.js" type="text/javascript"></script>
...
<body style="padding-left:10px; padding-top:10px;">
    ...
    <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:100%; line-height:40px;">
           ...
           <td style="text-align:left; width:180px;">
               ...
               <asp:TextBox ID="txtKeys" runat="server" nullText="请输入订单号/供应商/备注"></asp:TextBox>
