<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessTypeListAdd.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.ProcessTypeListAdd" %>
...
<body>
    ...
    <td>
        ...
        <asp:TextBox ID="txtSeq" runat="server"  ltype='spinner' 
