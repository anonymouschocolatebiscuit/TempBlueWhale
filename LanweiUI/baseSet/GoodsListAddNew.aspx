<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsListAddNew.aspx.cs" Inherits="Lanwei.Weixin.UI.BaseSet.GoodsListAddNew" %>
    ...
    <table id="form" border="1" cellpadding="0" cellspacing="20" style="line-height:45px;">
            ...
            <tr>
                <td style="text-align:right;">
                    显示类别：</td>
                <td>
                    <asp:RadioButton ID="rb1" runat="server" GroupName="aa" Text="默认" />
                    <asp:RadioButton ID="rb2" runat="server" GroupName="aa" Text="推荐" />
                    <asp:RadioButton ID="rb3" runat="server" GroupName="aa" Text="特价" />
                    <asp:RadioButton ID="rb4" runat="server" GroupName="aa" Text="新款" />
                    <asp:RadioButton ID="rb5" runat="server" GroupName="aa" Text="热销" />
                    <asp:RadioButton ID="rb6" runat="server" GroupName="aa" Text="赠品" />
                    <asp:RadioButton ID="rb7" runat="server" GroupName="aa" Text="缺货" />
                </td>
                <td align="right">
                    立即上架：</td>
                <td>
