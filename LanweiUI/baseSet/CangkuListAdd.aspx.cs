...
{
    public partial class CangkuListAdd : BasePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (id == 0)
            {
                ...
                {
                    MessageBox.Show(this, "新增失败，代码重复！");
                    return;
                }
                ...
                if (dal.Add() > 0)
                {
                    ...
                    logs.Events = "新增仓库：" + this.txtNames.Text;
            ...
            else
            {
                ...
                {
                    MessageBox.Show(this, "修改失败，代码重复！");
                    return;
                }
                ...
                if (dal.Update() > 0)
                {
                    ...
                    logs.ShopId = LoginUser.ShopId;
                    logs.Users = LoginUser.Phone + "-" + LoginUser.Names;
                    logs.Events = "修改仓库：" + this.txtNames.Text;
                    logs.Ip = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
                    logs.Add();
