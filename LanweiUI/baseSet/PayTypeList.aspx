<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayTypeList.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.PayTypeList" %>
        ...
        $(function ()
        {
            manager = $("#maingrid").ligerGrid({
                columns: [
                 ...
                 { display: '结算方式名称', name: 'names',id: 'levelName', width: 250, align: 'left' }
