...
namespace Lanwei.Weixin.UI.BaseSet
{
    public partial class GoodsListAdd : BasePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, "请输入商品编码！");
                return;
            }

            if (this.txtBarcode.Text.Trim() == "")
            {
                MessageBox.Show(this, "请输入商品条码！");
                return;
            }
            ...
            else //Edit
            {
                ...
                {
                    MessageBox.Show(this, "修改失败，存在相同编码！");
                    return;
                }
                ...
                //if (dal.isExistsNamesEdit(ConvertTo.ConvertInt(this.hf.Value.ToString()), LoginUser.ShopId, this.txtNames.Text))
                //{
                //    MessageBox.Show(this, "修改失败，存在相同名称！");
                //    return;
                //}
