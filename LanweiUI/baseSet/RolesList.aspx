<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RolesList.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.RolesList" %>
    ...
    <script src="../jsData/TreeDeptData.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
        ...
        $(function ()
        {
            manager = $("#maingrid").ligerGrid({
                columns: [
                 ...
                 { display: '角色名称', name: 'roleName', id: 'roleName', width: 250, align: 'left' },
                ...
                url: 'RolesList.aspx?Action=GetDataList', 
                ...
                { text: "添加角色", click: addRowTop,img: '../lib/ligerUI/skins/icons/add.gif'},
                { line: true },
               
                { text: "修改角色", click:editRow,img: '../lib/ligerUI/skins/icons/modify.gif'},
                { line: true },
               
                { text: "删除角色", click: deleteRow,img: '../lib/ligerUI/skins/icons/delete.gif'},
                { line: true },
        ...
        function editRow()
        {
            ...
            var title="修改角色-"+row.roleName;
           
            $.ligerDialog.open({ 
                title : title,
                url: 'RolesListAdd.aspx?roleId='+row.roleId+"&roleName="+row.roleName+"&parentId="+row.parentId+"&parentName="+row.parentName+"&flag="+row.flag,
                height:250,
                width:400,
                modal:false
              ...
              $.ligerDialog.confirm('删除后不能恢复，确认删除？', function(type) {
                ...
                if (type) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "RolesList.aspx",
                        data: "Action=delete&id=" + row.roleId + "&ranid=" + Math.random(), //encodeURI
        ...
        function addSubRow()
        {
            ...
            var title="添加子角色-"+row.roleName;
           
            $.ligerDialog.open({ 
                title : title,
                url: "RolesListAdd.aspx?roleId=0&roleName=&parentId="+row.roleId+"&parentName="+row.roleName+"&flag=0",
                height:250,
                width:400,
                modal:false
            });
        ...
        function addRowTop()
        {
            ...
            $.ligerDialog.open({ 
                title : title,
                url: "RolesListAdd.aspx?roleId=0&roleName=&parentId=0&parentName=顶级角色&flag=0",
                height:250,
                width:400,
                modal:false
            });
