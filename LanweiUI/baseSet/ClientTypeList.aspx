<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientTypeList.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.ClientTypeList" %>
        ...
        $(function ()
        {
            manager = $("#maingrid").ligerGrid({
                columns: [
                 ...
                 { display: '客户数量', name: 'num', width: 100, type: 'int', align: 'center' },             
