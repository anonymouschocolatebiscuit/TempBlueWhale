<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientList.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.ClientList" %>
  ...
  <script type="text/javascript">
        ...
        $(function() {
            ...
            checkbox: true,
                ...
                { text: "新增客户", click: addRowTop,img: '../lib/ligerUI/skins/icons/add.gif'},
                { line: true },
               
                { text: "修改客户", click:editRow,img: '../lib/ligerUI/skins/icons/modify.gif'},
                { line: true },
                ...
                { text: "删除客户", click: deleteRow,img: '../lib/ligerUI/skins/icons/delete.gif'},
                { line: true },
        ...
        {
            var row = manager.getSelectedRow();
            if (!row) {  $.ligerDialog.warn('请选择客户！'); return; }
       ...
       function search() {
            ...
            $.ligerDialog.prompt('可按照姓名、手机、电话、地址、备注查询','', function (yes,value) {
