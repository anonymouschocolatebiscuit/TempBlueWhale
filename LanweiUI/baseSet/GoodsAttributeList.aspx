<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsAttributeList.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.GoodsAttributeList" %>
    ...
    <script src="../jsData/TreeDeptData.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
        ...
        $(function ()
        {
            manager = $("#maingrid").ligerGrid({
                columns: [
                 ...
                 { display: '属性名称', name: 'names',id: 'levelName', width: 250, align: 'left' },
                ...
                url: 'GoodsAttributeList.aspx?Action=GetDataList', 
        ...
        function editRow()
        {
            ...
            $.ligerDialog.open({ 
                title : title,
                url: "GoodsAttributeListAdd.aspx?id="+row.id+"&names="+row.names+"&flag="+row.flag,
                height:250,
                width:400,
                modal:true
            });
        ...
        function addRowTop()
        {
            ...
            $.ligerDialog.open({ 
                title : title,
                url: 'GoodsAttributeListAdd.aspx',
                height:250,
                width:400,
                modal:true
            });
