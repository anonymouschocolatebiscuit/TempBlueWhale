    ...
    public partial class ProcessTypeListAdd : BasePage
    {
        ...
        public void BindDetail()
        {
            ...
            if (Request.QueryString.Count>0)
            {
                ...
                this.txtSeq.Text = Request.QueryString["seq"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            dal.Seq = ConvertTo.ConvertInt(this.txtSeq.Text);
            ...
            if (id == 0)
            {
                ...
                if (dal.Add() > 0)
                {
                    ...
                    logs.Events = "新增工序类别：" + this.txtNames.Text;
            ...
            else
            {
                ...
                if (dal.Update() > 0)
                {
                    ...
                    logs.ShopId = LoginUser.ShopId;
                    logs.Users = LoginUser.Phone + "-" + LoginUser.Names;
                    logs.Events = "修改工序类别：" + this.txtNames.Text;
                    logs.Ip = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
                    logs.Add();
