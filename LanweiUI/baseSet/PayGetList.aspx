<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayGetList.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.PayGetList" %>
        ...
        $(function ()
        {
            manager = $("#maingrid").ligerGrid({
                columns: [
                 ...
                 { display: '类别', name: 'types',id: 'types', width: 250, align: 'left' },
