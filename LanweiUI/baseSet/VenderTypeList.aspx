<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VenderTypeList.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.VenderTypeList" %>
    ...
    <script src="../jsData/TreeDeptData.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
        ...
        $(function ()
        {
            manager = $("#maingrid").ligerGrid({
                columns: [
                 ...
                 { display: '分类名称', name: 'names',id: 'levelName', width: 250, align: 'left' },
                 { display: '供应商数量', name: 'num', width: 100, type: 'int', align: 'center' },             
        ...
        function editRow()
        {
            ...
            $.ligerDialog.open({ 
                title : title,
                url: "VenderTypeListAdd.aspx?id="+row.id+"&names="+row.names+"&flag="+row.flag,
                height:250,
                width:400,
                modal:true
            });
