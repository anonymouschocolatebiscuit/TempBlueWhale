<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientListSelect.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.ClientListSelect" %>
    ...
    function keyDownSearch(e) {    
        ...
        function f_select()
        {
          ...
          function search() {
                ...
                manager._setUrl("ClientListSelect.aspx?Action=GetDataListSearch&keys="+keys+"&typeId="+typeId); 
...
<body>
   ...
   <td style="width:300px;">
       <asp:TextBox ID="txtKeys" runat="server" nullText="请输入手机/姓名/备注/地址"></asp:TextBox>
       </td>
