<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessTypeList.aspx.cs" Inherits="Lanwei.Weixin.UI.baseSet.ProcessTypeList" %>
    ...
    <script src="../lib/json2.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
        ...
        $(function ()
        {
            manager = $("#maingrid").ligerGrid({
                columns: [
                  ...
                  { display: '显示顺序', name: 'seq', id: 'seq', width: 250, align: 'left' }
        ...
        function editRow()
        {
            ...
            $.ligerDialog.open({ 
                title : title,
                url: "ProcessTypeListAdd.aspx?id=" + row.id + "&names=" + row.names + "&seq=" + row.seq,
                height:300,
                width:400,
                modal:true
            });
