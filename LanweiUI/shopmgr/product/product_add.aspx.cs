...
namespace Lanwei.Weixin.Web.shopmgr.product
{
    public partial class product_add : Web.UI.ManagePage
    {
       ...
       /// <param name="e"></param>
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Lanwei.Weixin.Model.wx_shop_product model = new Lanwei.Weixin.Model.wx_shop_product();
            model.wid = wid;
            ...
            Lanwei.Weixin.BLL.wx_shop_product bll = new Lanwei.Weixin.BLL.wx_shop_product();
