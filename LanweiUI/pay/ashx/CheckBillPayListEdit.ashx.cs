...
namespace Lanwei.Weixin.UI.pay.ashx
{
    ...
    public class CheckBillPayListEdit : IHttpHandler, IRequiresSessionState  //用Session必须引用IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (pId > 0)
            {
                ...
                if (check > 0)
                {
                    ...
                    logs.Events = "修改付款核销单：" + obj.Id.ToString();
