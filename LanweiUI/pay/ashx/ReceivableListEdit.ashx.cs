...
{
    /// <summary>
    /// ReceivableListEdit 的摘要说明
    /// </summary>
    public class ReceivableListEdit : IHttpHandler, IRequiresSessionState  //用Session必须引用IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (pId > 0)
            {
                ...
                if (check > 0)
                {
                    ...
                    logs.Events = "修改收款单：" + obj.id.ToString();
