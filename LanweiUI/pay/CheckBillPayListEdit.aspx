<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckBillPayListEdit.aspx.cs" Inherits="Lanwei.Weixin.UI.pay.CheckBillPayListEdit" %>
...
<body style=" padding-top:10px; padding-left:10px;">
 ...
 <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
          ...
          <asp:DropDownList ID="ddlVenderList" runat="server" Width="250px">
           ...
           &nbsp;<input id="btnSelectPay" type="button" value="查询付款单" class="ui-btn" 
           ...
           &nbsp;<input id="btnSelectBill" type="button" value="查询应付单" class="ui-btn" 
