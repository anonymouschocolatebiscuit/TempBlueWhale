...
//                        h += "<a href='javascript:cancelEdit(" + rowindex + ")'>取消</a> "; 
                ...
                { display: '收款金额', name: 'payPrice', width: 120, type: 'float', align: 'right',editor: { type: 'float' },
                ...
                url: 'ReceivableListEdit.aspx?Action=GetData&id='+getUrlParam("id"),//获取参数
...
//                        h += "<a href='javascript:cancelEdit(" + rowindex + ")'>取消</a> "; 
               ...
               url: 'ReceivableListEdit.aspx?Action=GetDataSub&id='+getUrlParam("id"),//获取参数
               rownumbers:true,//显示序号
               frozenRownumbers:true,//行序号是否在固定列中
                dataAction: 'local',//本地排序
                usePager:false,
