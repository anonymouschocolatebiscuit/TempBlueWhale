           ...
           var menu = $.ligerMenu({ width: 120, items:
            ...
            checkbox: true,
                columns: [
                 ...
                 { display: '结算账户', name: 'bkName', width: 80, align: 'center' },
                 { display: '客户', name: 'wlName', width: 170, align: 'left'},
                 { display: '收款金额', name: 'sumPrice', width: 100, align: 'right',
      ...
      function add()
      {
          ...
          parent.f_addTab('OtherGetListAdd','其他收款-新增','pay/OtherGetListAdd.aspx?id=0');
      ...
      function editRow()
      {
          ...
          parent.f_addTab('OtherGetListEdit','其他收款-修改','pay/OtherGetListEdit.aspx?id='+row.id);
      ...
      function viewRow()
      {
          var row = manager.getSelectedRow();
           ...
           parent.f_addTab('OtherGetListEdit','其他收款-详情','pay/OtherGetListEdit.aspx?id='+row.id);
