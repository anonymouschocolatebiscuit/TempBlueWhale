        ...
        var form = $("#form").ligerForm();
            ...
            checkbox: true,
                ...
                { display: '收款日期', name: 'bizDate', width: 80, align: 'center',valign:'center',
                 ...
                 { display: '销货单位', name: 'wlName', width: 170, align: 'left'},
                 { display: '收款金额', name: 'payPriceSum', width: 80, align: 'right',
                 ...
                 { display: '本次预收款', name: 'payPriceNowMore', width: 90, align: 'right',
      ...
      function add()
      {
          ...
          parent.f_addTab('ReceivableListAdd','销售收款-新增','pay/ReceivableListAdd.aspx');
      ...
      function editRow()
      {
          ...
          parent.f_addTab('ReceivableListEdit','销售收款-修改','pay/ReceivableListEdit.aspx?id='+row.id);
     ...
     function viewRow()
      {
          var row = manager.getSelectedRow();
           ...
           parent.f_addTab('ReceivableListEdit','销售收款-详情','pay/ReceivableListEdit.aspx?id='+row.id);
