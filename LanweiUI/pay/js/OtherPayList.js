           ...
           var menu = $.ligerMenu({ width: 120, items:
            ...
            checkbox: true,
                columns: [
                 ...
                 { display: '付款金额', name: 'sumPrice', width: 100, align: 'right',
      ...
      function add()
      {
          ...
          parent.f_addTab('OtherPayListAdd','其他付款-新增','pay/OtherPayListAdd.aspx');
      ...
      function editRow()
      {
          ...
          parent.f_addTab('OtherPayListEdit','其他付款-修改','pay/OtherPayListEdit.aspx?id='+row.id);
      ...
      function viewRow()
      {
          var row = manager.getSelectedRow();
           ...
           parent.f_addTab('OtherPayListEdit','其他付款-详情','pay/OtherPayListEdit.aspx?id='+row.id);
