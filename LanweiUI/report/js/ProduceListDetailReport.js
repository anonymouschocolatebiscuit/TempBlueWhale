            ...
            manager = $("#maingrid").ligerGrid({
                ...
                columns: [
                 ...
                 { display: '仓库', name: 'ckName', width: 100, align: 'center'},
                    ...
                    {
                        display: '数量', name: 'num', width: 100, align: 'right',
                 ...
                 {
                     display: '成本单价', name: 'price', width: 80, type: 'float', align: 'right', editor: { type: 'float' }

                 },

        
        {
            display: '成本金额', name: 'sumPriceNow', width: 100, type: 'float', align: 'right', editor: { type: 'float' },
