         ...
         txtFlagList.set("Width", 100);
            ...
            manager = $("#maingrid").ligerGrid({
                ...
                columns: [
                 ...
                 { display: '销售日期', name: 'bizDate', width: 80, align: 'center',valign:'center'},
...
//            alert(typeId);
//            alert(wlId);
            // alert("SalesOrderListDetailReport.aspx?Action=GetDataList&start=" + start + "&end=" + end + "&wlId=" + wlId + "&goodsId=" + goodsList + "&typeId=" + typeId);
