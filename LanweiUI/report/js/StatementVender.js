         ...
         txtVenderList.set("Width", 310);
            ...
            manager = $("#maingrid").ligerGrid({
                ...
                columns: [
                 ...
                 { display: '采购金额', name: 'sumPrice', width: 120, align: 'right',
                 ...
                 { display: '整单折扣额', name: 'disPrice', width: 120, align: 'right',
                  ...
                  { display: '应付金额', name: 'payNeed', width: 120, align: 'right',
                  ...
                  { display: '实际付款金额', name: 'payReady', width: 120, align: 'right',
                  ...
                  { display: '应付款余额', name: 'payEnd', width: 120, align: 'right'}
