         ...
         txtVenderList.set("Width", 310);
            ...
            manager = $("#maingrid").ligerGrid({
                ...
                columns: [
                 ...
                 { display: '供应商', name: 'wlName', width: 200, align: 'left',
                 ...
                 { display: '增加应付款', name: 'payNeed', width: 180, align: 'right',
                 ...
                 { display: '增加预付款', name: 'payReady', width: 180, align: 'right',
                  ...
                  { display: '应付款余额', name: 'payEnd', width: 180, align: 'right'
        ...
        function search() {
            ...
            manager._setUrl("VenderNeedPayReport.aspx?Action=GetDataList&start="+start+"&end="+end+"&typeId="+typeId);
        }
