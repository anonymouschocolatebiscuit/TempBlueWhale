<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VenderNeedPayReport.aspx.cs" Inherits="Lanwei.Weixin.UI.report.VenderNeedPayReport" %>
...
<head runat="server">
    ...
    <script src="js/VenderNeedPayReport.js" type="text/javascript"></script>
    ...
    <form id="form1" runat="server">
     <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
      ...
      <script type="text/javascript">
            ...
            //    isShowCheckBox: true, 
            //    isMultiSelect: true,
            //    url:"../baseSet/VenderList.aspx?Action=GetDDLList&r=" + Math.random(), 
            //    valueField: 'code',
            //    textField:'names'
            //    ,valueFieldID: 'id'
            //}); 
