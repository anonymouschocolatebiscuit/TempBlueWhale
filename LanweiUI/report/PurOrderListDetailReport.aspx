<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurOrderListDetailReport.aspx.cs" Inherits="Lanwei.Weixin.UI.report.PurOrderListDetailReport" %>
     ...
     <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
           ...
           <td style="text-align:right; padding-right:20px;">
              ...
              <input id="btnSearch" type="button" value="查询" class="ui-btn ui-btn-sp mrb" onclick="search(0)" />
               ...
               <input id="btnToExcel" type="button" value="导出Excel" class="ui-btn" onclick="search(1)" />
