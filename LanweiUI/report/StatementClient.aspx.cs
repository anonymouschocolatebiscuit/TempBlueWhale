...
{
    public partial class StatementClient : BasePage
    {
        ...
        void GetDataList(DateTime bizStart,DateTime bizEnd,string typeId)
        {
            ...
            DataSet ds = dal.GetAllModelClientStatement(LoginUser.ShopId, bizStart, bizEnd, typeId);
