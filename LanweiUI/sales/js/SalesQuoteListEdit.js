...
//                        h += "<a href='javascript:cancelEdit(" + rowindex + ")'>取消</a> "; 
                ...
                url: 'SalesQuoteListEdit.aspx?Action=GetData&id='+getUrlParam("id"),//获取参数
...
            var grid = liger.get("maingrid");
            ...
            grid.updateRow(grid.lastEditRow, {
                ...
                price: selected.priceCost,//未税单价
                sumPrice:selected.priceCost,//未税金额
                tax:0,
                priceTax:selected.priceCost,//含税单价、默认为不含税单价
                sumPriceTax:0,//税额
                sumPriceAll:selected.priceCost,//价税合计
                remarks:""
...
                        id:rowNumber,
                        ...
                        price : e.data[i].priceCost,//未税单价
                        sumPrice:e.data[i].priceCost,//未税金额
                        tax:0,
...
//    var checkText=$("#ddlVenderList").find("option:selected").text();  //获取Select选择的Text
     ...
     var packageWay=$("#ddlPackageList").val(); 
           ...
           var headJson={id:getUrlParam("id"),venderId:venderId,bizDate:bizDate,bizId:bizId,deadLine:deadLine,sendPlace:sendPlace,isTax:isTax,isFreight:isFreight,freightWay:freightWay,packageWay:packageWay,payWay:payWay,payDate:payDate,sendDate:sendDate,remarks:remarks};
...
//       $("#txtRemarks").val(JSON.stringify(postData));
         ...
         $.ajax({
            type: "POST",
            url: 'ashx/SalesQuoteListEdit.ashx',
