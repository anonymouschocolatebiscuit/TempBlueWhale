           ...
           var menu = $.ligerMenu({ width: 120, items:
            ...
            checkbox: true,
                columns: [
                 ...
                 { display: '销售人', name: 'bizName', width: 80, align: 'center' },
      ...
      function add()
      {
         ...
         parent.f_addTab('SalesOrderListAdd','销售订单-新增','sales/SalesOrderListAdd.aspx');
...
//          });
      ...
      function editRow()
      {
          ...
          if (!row) { alert('请选择行'); return; }
           ...
           parent.f_addTab('SalesOrderListEdit','销售订单-修改','sales/SalesOrderListEdit.aspx?id='+row.id);
...
//  
      ...
      function viewRow()
      {
         ...
         // alert(row.id);
           ...
           parent.f_addTab('SalesOrderListEdit','销售订单-详情','sales/SalesOrderListEdit.aspx?id='+row.id);
          ...
          $.ajax({
              ...
              success: function (resultString) {
                  ...
                  if (resultString == '生成成功！') {
                      ...
                      parent.f_addTab('pdf', '销售订单-打印预览', 'sales/pdf/' + shopId + '-' + number + '.pdf');
          ...
          $.ajax({
              ...
              success: function (resultString) {
                  ...
                  if (resultString == '生成成功！') {
                      ...
                      parent.f_addTab('pdf', '销售订单-打印预览', 'sales/pdf/' + shopId + '-' + number + '-01.pdf');
