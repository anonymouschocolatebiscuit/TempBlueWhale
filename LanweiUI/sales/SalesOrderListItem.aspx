<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderListItem.aspx.cs" Inherits="Lanwei.Weixin.UI.sales.SalesOrderListItem" %>
...
<head runat="server">
    ...
    <script src="js/SalesOrderListItem.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
     <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
           ...
           <input id="btnLockNum" type="button" value="锁定库存" class="ui-btn" onclick="lockNum()" />
           
           <input id="btnLockNo" type="button" value="取消锁库" class="ui-btn" onclick="lockNumNo()" />
           
           <input id="btnBuy" type="button" value="下采购单" class="ui-btn" onclick="checkRow()" />
      ...
      <script type="text/javascript">
            ...
            $("#txtFlagList").ligerComboBox({ isShowCheckBox: true, isMultiSelect: true,
                data: [
                    { text: '未出库', id: '1' },
                    { text: '部分出库', id: '2' },
                    { text: '全部出库', id: '44' }
