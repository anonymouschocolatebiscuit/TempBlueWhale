<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReceiptListEdit.aspx.cs" Inherits="Lanwei.Weixin.UI.sales.SalesReceiptListEdit" %>
 ...
 <table id="tbFooter" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:50px;">
          ...
          <td style="text-align:right; width:80px;">
           ...
           <td style="text-align:right; padding-right:30px; ">
               ...
               <input id="btnSave" class="ui-btn ui-btn-sp mrb" type="button" value="保 存" onclick="save()"  runat="server" /><asp:HiddenField ID="hf" runat="server" />
                   &nbsp;</td>
           </tr>
           </table>
