...
namespace Lanwei.Weixin.UI.sales.ashx
{
    ...
    public class SalesOrderListEdit : IHttpHandler, IRequiresSessionState  //用Session必须引用IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            dal.Number = "";// dal.GetBillNumberAuto();//"CGDD"+DateTime.Now.ToString("yyyyMMddhhmmssfff");//
            ...
            if (pId > 0)
            {
                ...
                if (check > 0)
                {
                    ...
                    logs.Events = "修改销售订单：" + obj.Id.ToString();
