...
{
    /// <summary>
    /// SalesQuoteListEdit 的摘要说明
    /// </summary>
    public class SalesQuoteListEdit : IHttpHandler, IRequiresSessionState  //用Session必须引用IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!basePage.CheckPower("SalesQuoteListEdit"))
            {
            ...
            if (pId > 0)
            {
                ...
                if (check > 0)
                {
                    ...
                    logs.Events = "修改销售报价单：" + obj.id.ToString();
