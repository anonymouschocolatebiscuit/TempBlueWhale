<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderList.aspx.cs" Inherits="Lanwei.Weixin.UI.sales.SalesOrderList" %>
...
<body style="padding-left:10px; padding-top:10px;">
    ...
    <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:100%; line-height:40px;">
           ...
           <td style="text-align:left; width:180px;">
               ...
               <asp:TextBox ID="txtKeys" runat="server" nullText="请输入订单号/客户/备注"></asp:TextBox>
