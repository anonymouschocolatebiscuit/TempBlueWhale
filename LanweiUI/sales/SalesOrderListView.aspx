<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderListView.aspx.cs" Inherits="Lanwei.Weixin.UI.sales.SalesOrderListView" %>
...
<body style=" padding-top:10px; padding-left:10px;">
 ...
 <table id="tbFooter" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:50px;">
           ...
           <td style="text-align:right; padding-right:30px; ">
               ...
               <input id="Button1" class="ui-btn ui-btn-sp mrb" type="button" value="生成出库单" onclick="makeBill()"  /
