<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="produceListSelect.aspx.cs" Inherits="Lanwei.Weixin.UI.produce.produceListSelect" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
          ...
          //  window.open('produceListSelect.aspx?Action=GetDataList');
            ...
            manager = $("#maingrid").ligerGrid({
               ...
               { display: '计划编号', name: 'number', width: 150, align: 'center' },
                 ...
                 { display: '商品名称', name: 'goodsName', width: 150, align: 'left' },
                  ...
                  { display: '已生产数量', name: 'finishNum', width: 80, align: 'center' },
                  { display: '未生产数量', name: 'finishNumNo', width: 80, align: 'center' },
                  { display: '开始日期', name: 'dateStart', width: 80, align: 'center' }
    ...
    <form id="form1" runat="server">
         ...
         <table id="form" border="0" cellpadding="0" cellspacing="0" style="line-height:40px;">
           ...
           <td style="text-align:left; width:220px;">
               ...
               <asp:TextBox ID="txtKeys" runat="server" nullText="请输入计划单号/商品/客户/备注"></asp:TextBox>
