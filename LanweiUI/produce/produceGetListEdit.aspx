<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="produceGetListEdit.aspx.cs" Inherits="Lanwei.Weixin.UI.produce.produceGetListEdit" %>
...
<body style=" padding-top:10px; padding-left:10px;">
 ...
 <table id="tbFooter" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:50px;">
           ...
           <td style="text-align:right; padding-right:30px; ">
               ...
               <input id="btnSave" class="ui-btn ui-btn-sp mrb" type="button" runat="server" value="保 存" onclick="save()"  />
