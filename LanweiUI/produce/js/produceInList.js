           ...
           var menu = $.ligerMenu({ width: 120, items:
            ...
            checkbox: true,
                columns: [
                 ...
                 { display: '单据编号', name: 'number', width: 180, align: 'center' },
                
                  { display: '入库数量', name: 'sumNum', width: 100, align: 'right',
                 ...
                 { display: '成本金额', name: 'sumPriceAll', width: 150, align: 'right',
                 ...
                 { display: '状态', name: 'flag', width: 100, align: 'center'},
                 
              
              
                 { display: '制单人', name: 'makeName', width: 100, align: 'center' },
                 { display: '入库人', name: 'bizName', width: 100, align: 'center' },
      ...
      function add()
      {
          ...
          parent.f_addTab('produceInListAdd', '生产入库-新增', 'produce/produceInListAdd.aspx?id=0');
      ...
      function editRow()
      {
          ...
          parent.f_addTab('produceInListEdit', '生产入库-修改', 'produce/produceInListEdit.aspx?id=' + row.id);
