<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="produceProcessList.aspx.cs" Inherits="Lanwei.Weixin.UI.produce.produceProcessList" %>
...
<title>生成工序查询</title>
    ...
    <script src="js/produceProcessList.js" type="text/javascript"></script>
...
<body style="padding-left:10px; padding-top:10px;">
    ...
    <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:100%; line-height:40px;">
           ...
           <td style="text-align:left; width:180px;">
               ...
               <asp:TextBox ID="txtKeys" runat="server" nullText="请输入工序/员工/商品/客户/备注"></asp:TextBox>
           ...
           &nbsp;<input id="btnCheck" type="button" value="审核" class="ui-btn" onclick="checkRow()" />
             ...
             <input id="btnDelete" type="button" value="删 除" class="ui-btn" onclick="deleteRow()" />
