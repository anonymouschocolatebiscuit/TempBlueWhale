...
namespace Lanwei.Weixin.UI.produce
{
    public partial class produceGetListEdit : BasePage
    {
        ...
        public void BindInfo()
        {
            ...
            DAL.produceGetList dal = new DAL.produceGetList();
            ...
            DAL.ProduceListDAL planDAL = new ProduceListDAL();
        ...
        void GetDataListBom(int pId,int goodsId,int produceNumNo)
        {
            ...
            //从生产计划获取清单
            DAL.ProduceListItemBomDAL dal = new ProduceListItemBomDAL();
        ...
        void GetDataListGet(int pId)
        {
            ...
            //从生产领料获取清单
            DAL.produceGetListItem dal = new produceGetListItem();
