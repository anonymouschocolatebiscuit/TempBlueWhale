<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="goodsBomListType.aspx.cs" Inherits="Lanwei.Weixin.UI.produce.goodsBomListType" %>
       ...
       <script type="text/javascript">
        ...
        $(function ()
        {
            manager = $("#maingrid").ligerGrid({
                ...
                { display: '顺序', name: 'sortId', id: 'sortId', width: 250, align: 'left' }
