...
namespace Lanwei.Weixin.UI.produce.ashx
{
    ...
    public class goodsBomListAdd : IHttpHandler, IRequiresSessionState  //用Session必须引用IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                context.Response.Write("此物料已存在BOM，请勿重复添加！");
                return;
            ...
            if (pId > 0)
            {
                ...
                if (check > 0)
                {
                    ...
                    logs.Events = "新增商品BOM清单：" +model.number;
