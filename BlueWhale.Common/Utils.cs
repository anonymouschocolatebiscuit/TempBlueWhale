...
namespace BlueWhale.Common
{
    public class Utils
    {
        ...
        /// <summary>
        /// check target is valid email string 
        /// </summary>
        /// <param name="strEmail">input email string</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="strUrl">input url</param>
        /// <returns></returns>
        ...
        /// <param name="speater">seperator</param>
        ...
        /// <param name="defValue">require value</param>
        ...
        /// </summary>
        /// <param name="strValue">string</param>
        /// <param name="defValue">text to check</param>
        /// <returns>return bool result</returns>
        ...
        /// </summary>
        /// <param name="expression">convert object</param>
        /// <param name="defValue">value to check</param>
        /// <returns>return int32 result</returns>
        ...
        /// <param name="expression">convert object</param>
        /// <param name="defValue">value to check</param>
        /// <returns>return decimal result</returns>
        ...
        /// <summary>
        /// convert obejct to float
        /// </summary>
        /// <param name="expression">convert object</param>
        /// <param name="defValue">value to check</param>
        /// <returns>return float result</returns>
        ...
        /// </summary>
        /// <param name="str">convert object</param>
        /// <param name="defValue">value to check</param>
        /// <returns>return DateTime result</returns>
        ...
        /// convert object to DateTime
        /// </summary>
        /// <param name="obj">convert object</param>
        /// <param name="defValue">value to check</param>
        /// <returns>return DateTime result</returns>
        ...
        /// getDayName
        /// </summary>
        /// <param name="dayTimes">date</param>
        /// <returns></returns>
        ...
        #region generate specific length string
        /// <summary>
        /// generate string to specific length
        /// </summary>
        /// <param name="strLong">generate length</param>
        /// <param name="str">to generate string</param>
        /// <returns></returns>
        ...
        #region generate random alphabet or number
        /// <summary>
        ...
        /// </summary>
        /// <param name="Length">generate length</param>
        /// <param name="Sleep">prevent duplicate</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// generate random alphabet or number mix
        /// </summary>
        /// <param name="codeCount">generate count</param>
        ...
        ///clear HTML tag
        ///</summary>   
        ///<param name="NoHTML">string contain HTML</param>   
        ///<returns>process text does not contain HTML</returns>   
        ...
        /// convert to html
        /// </summary>
        /// <param name="theString">input string</param>
        /// <returns>convert to HTML</returns>
        ...
        /// <summary>
        /// recover html special text
        /// </summary>
        /// <param name="theString">input HTML </param>
        /// <returns>convert to text</returns>
        ...
        #region remove HTML tag output length
        ...
        #region convert TXT to HTML format
        /// <summary>
        /// convert TXT into HTML format
        /// </summary>
        /// <param name="chr">input string</param>
        /// <returns>process text</returns>
        ...
        #region convert HTML code to text format
        /// <summary>
        /// convert html code into txt format
        /// </summary>
        /// <param name="chr">input string</param>
        /// <returns>process text</returns>
        ...
        #region check sql contain injection attack string
        /// <summary>
        /// check sql contain injection attack string
        /// </summary>
        /// <param name="str">input string</param>
        /// <returns>if not contain，return true，else false </returns>
        ...
        public static string Filter(string sInput)
        {
            ...
            {
                throw new Exception("string contain invalid string!");
            }
            else
            {
        ...
        /// <summary> 
        /// check input string contain danger text
        /// </summary> 
        /// <param name="InText">input string </param> 
        /// <returns>if contain invalid text，return true </returns> 
        ...
        #region get file node XML file absolute path
        ...
        /// <summary>
        /// get webconfig，appSettings value
        /// </summary>
        ...
        #region Get current absolute path
        /// <summary>
        ...
        /// <summary>
        /// delete upload file (and thumbnail)
        /// </summary>
        ...
        public static void DeleteUpFile(string _filepath)
        {
            ...
            string fullpath = GetMapPath(_filepath); //original image
            if (File.Exists(fullpath))
            {
                File.Delete(fullpath);
            }
            if (_filepath.LastIndexOf("/") >= 0)
            {
                ...
                string fullTPATH = GetMapPath(thumbnailpath); //thumbnail
        ...
        /// </summary>
        /// <param name="_dirpath">file path</param>
        ...
        /// <summary>
        /// edit specific folder name
        /// </summary>
        /// <param name="old_dirpath">old path</param>
        /// <param name="new_dirpath">new path</param>
        ...
        /// <summary>
        /// return fileextension，no imclude "."
        /// </summary>
        /// <param name="_filepath">file full name</param>
        /// <returns>string</returns>
        ...
        /// <summary>
        /// return file name，not include file path
        /// </summary>
        /// <param name="_filepath">file path</param>
        /// <returns>string</returns>
        ...
        /// </summary>
        /// <param name="strName">name</param>
        /// <param name="strValue">vaue</param>
        ...
        /// <param name="strName">name</param>
        /// <param name="strValue">value</param>
        /// <param name="strValue">expire duration(minute)</param>
        ...
        #region convert to specific string
        /// <summary>
        ...
        #region display tab
        /// <summary>
        /// display tab page list
        /// </summary>
        /// <param name="pageSize">page size</param>
        /// <param name="pageIndex">current page</param>
        /// <param name="totalCount">total number of records</param>
        /// <param name="linkUrl">link address, __id__ represents page number</param>
        /// <param name="centSize">number of intermediate pages</param>
        /// <returns></returns>
        public static string OutPageList(int pageSize, int pageIndex, int totalCount, string linkUrl, int centSize)
        {
            ...
            string firstBtn = "<a href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex - 1).ToString()) + "\">«Previous page</a>";
            string lastBtn = "<a href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex + 1).ToString()) + "\">Next page»</a>";
            ...
            if (pageIndex <= 1)
            {
                firstBtn = "<span class=\"disabled\">«Previous page</span>";
            }
            if (pageIndex >= pageCount)
            {
                lastBtn = "<span class=\"disabled\">Next page»</span>";
            }
            if (pageIndex == 1)
            {
            ...
            int firstNum = pageIndex - (centSize / 2); //Page number starting from the middle
            if (pageIndex < centSize)
                firstNum = 2;
            int lastNum = pageIndex + centSize - ((centSize / 2) + 1); //Ending page number
            if (lastNum >= pageCount)
                lastNum = pageCount - 1;
            pageStr.Append("<span>Total" + totalCount + "records</span>");
        ...
        /// <summary>
        /// conbine url parameter
        /// </summary>
        /// <param name="_url">url</param>
        /// <param name="_keys">param name</param>
        /// <param name="_values">parma value</param>
        /// <returns>String</returns>
        ...
        #region URLrequest data
        /// <summary>
        /// HTTP POST method request data
        /// </summary>
        ...
        /// <summary>
        /// execute url to get content data
        /// </summary>
        ...
        #region operate permission menu
        /// <summary>
        ...
        /// <summary>
        /// convert extension，if no extension use default page
        /// </summary>
