    ...
    <form id="form1" runat="server">
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
            <tr>
                ...
                <td style="text-align:center; width:40px;">To</td>
                ...
                <td style="text-align:left; width:150px; padding-right: 0.5rem;">
        ...
        <script type="text/javascript">
            ...
            // Initialize Goods selection popup
            $("#txtGoodsList").ligerPopupEdit({
                condition: {
                    prefixID: 'condtion_',
                    fields: [
                        { name: 'names', type: 'text', label: 'Product Name' }
                    ]
                },
            ...
            // Get Goods list grid configuration
