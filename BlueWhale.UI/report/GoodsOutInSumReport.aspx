            ...
            <script type="text/javascript">
                $("#btn1").ligerButton({
                 ...
                 $("#txtGoodsList").ligerPopupEdit({
                    condition: {
                        prefixID: 'condtion_',
                        fields: [{ name: 'names', type: 'text', label: 'GoodsName' }]
                    },
                 ...
                 function getGridGoodsList(checkbox) {
                    var options = {
                        columns: [
                          { display: 'GoodCode', name: 'code', width: 100, align: 'center' },
                     { display: 'GoodsName', name: 'names', width: 230, align: 'left'},
                      { display: 'Specific', name: 'spec', width: 70, align: 'center' },
                      { display: 'UnitName', name: 'unitName', width: 70, align: 'center' }
                        ], switchPageSizeApplyComboBox: false,
                        
                      url: '../baseSet/GoodsList.aspx?Action=GetDataList', 
                      pageSize: 15,
                      dataAction: 'local', //sort
                      usePager: true,
                        checkbox: checkbox
                    };
                    return options;
