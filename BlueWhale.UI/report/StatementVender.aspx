<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatementVender.aspx.cs" Inherits="BlueWhale.UI.report.StatementVender" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Vender Statement</title>
    ...
    <script type="text/javascript">
        function f_selectClient() {
            $.ligerDialog.open({
                title: 'Vender Statement', name: 'winselector', width: 800, height: 540, url: '../baseSet/VenderListSelect.aspx', buttons: [
    ...
    <script src="js/StatementVender.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width: 99%; line-height: 40px;">
            <tr>
                <td style="text-align: right; width: 40px;">Date：             
                </td>
