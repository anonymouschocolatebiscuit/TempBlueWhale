...
{
    public partial class StatementVender : BasePage
    {
        ...
        {
            DataSet ds = dal.GetAllModelVenderStatement(LoginUser.ShopId, bizStart, bizEnd, typeId);
            ...
            for (var i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                list.Add(new
                {
                    ...
                    payEnd = (i == 0) ? payEnd.ToString() : payEndNow.ToString()
                });
            }
