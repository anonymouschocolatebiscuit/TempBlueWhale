...
$(function () {
    ...
    manager = $("#maingrid").ligerGrid({
        columns: [
            {
                display: 'Item Number', name: 'code', width: 170, align: 'center',
                display: 'Item Number', name: 'code', width: 110, align: 'center',
            ...
            { display: 'Item Name', name: 'goodsName', width: 110, align: 'left' },
            { display: 'Specification', name: 'spec', width: 110, align: 'center' },
            { display: 'Unit', name: 'unitName', width: 110, align: 'center' },
            { display: 'Warehouse', name: 'ckName', width: 110, align: 'center' },
            {
            ...
            {
                display: 'Quantity', name: 'sumNum', width: 110, align: 'right',
                totalSummary:
                {
            ...
            {
                display: 'Amount', name: 'sumPriceNow', width: 110, type: 'float', align: 'right', editor: { type: 'float' },
                totalSummary:
                {
