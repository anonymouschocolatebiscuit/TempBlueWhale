         ...
         txtFlagList.set("Width", 100);
            ...
            manager = $("#maingrid").ligerGrid({
                ...
                columns: [
                 ...
                 { display: 'Warehouse', name: 'ckName', width: 100, align: 'center'},
                  ...
                  {
                      display: 'Average Unit Price', name: 'sumPriceAll', width: 170, align: 'right',
                  ...
                  },
            {
                ...
                totalSummary:
                 ...
                 {
                     display: 'Total price with tax', name: 'sumPriceAll', width: 170, align: 'right',
...
//            alert(goodsList);
            ...
            manager._setUrl("SalesOrderListSumGoodsReport.aspx?Action=GetDataList&start="+start+"&end="+end+"&wlId="+wlId+"&goodsId="+goodsList+"&typeId="+typeId);
        }
