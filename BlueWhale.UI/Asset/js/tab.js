    ...
    Tab.prototype.tabAdd = function (data) {
        ...
        if (_config.contextMenu) {
            ...
            ELEM.titleBox.find('li').on('contextmenu', function (e) {
                ...
                var ul = '<ul>';
                ul += '<li data-target="refresh" title="Refresh Current Tab"><i class="fa fa-refresh" aria-hidden="true"></i> Refresh</li>';
                ul += '<li data-target="closeCurrent" title="Close Current Tab"><i class="fa fa-close" aria-hidden="true"></i> Close Current Tab</li>';
                ul += '<li data-target="closeOther" title="Close Other Tab"><i class="fa fa-window-close-o" aria-hidden="true"></i> Close Other Tab</li>';
                ul += '<li data-target="closeAll" title="Close All Tab"><i class="fa fa-window-close-o" aria-hidden="true"></i> Close All Tab</li>';
                ul += '</ul>';
                div.innerHTML = ul;
