...
layui.define(['element', 'common', 'paging', 'form'], function (exports) {
    ...
    BTable.prototype.render = function () {
        ...
        if (_config.checkbox && !_config.singleSelect) {
            th = '<th style="width:40px;"><input type="checkbox" lay-filter="allselector" lay-skin="primary" /></th><th style="width:40px;">序号</th>' + th;
        } else if (_config.checkbox) {
            th = '<th style="width:40px;">#</th><th style="width:40px;">序号</th>' + th;
        } else {
            th = '<th style="width:40px;">序号</th>' + th;
        }
    ...
    function getTpl(options) {
        ...
        tpl += '<tr col="' + colLength + '">Currently No Data.</tr>';
        tpl += '{{# } }}';
        //console.log(tpl);
        return tpl;
    }
