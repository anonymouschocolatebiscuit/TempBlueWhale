<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReceiptList.aspx.cs" Inherits="BlueWhale.UI.sales.SalesReceiptList" %>
...
<head runat="server">
    ...
    <script src="js/SalesReceiptList.js" type="text/javascript"></script>
                ...
                <style type="text/css">
                #keyword .l-text, .l-text:has(#txtKeys) {
    ...
    <form id="form1" runat="server">
        ...
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width: 100%; line-height: 40px;">
            <tr>
                ...
                <td style="text-align: left; width: 320px;" id="keys">
