...
<head runat="server">
    <title>Sales Receipt List Edit</title>
...
<body style=" padding-top:10px; padding-left:10px;">
    <form id="form1" runat="server">
        ...
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
            <tr>
                <td style="width:180px; text-align:center;">Sales Unit:</td>
                ...
                <td style="text-align:right; width:180px;">Outbound Date:</td>
                <td style="text-align:left; width:180px;">
                    <asp:TextBox ID="txtBizDate" runat="server" ltype="date" validate="{required:true}"></asp:TextBox>
                </td>
                <td style="text-align:right; width:180px;">Salesperson:</td>
                <td style="text-align:left; width:180px;" >
 ...
 <div id="maingrid"></div>
            ...
            <table id="tbFooter" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:50px;">
               <tr>
                   <td style="width:180px; text-align:right;">Current Payment Received:</td>
                   <td style="text-align:left; width:100px;">
                       <asp:TextBox ID="txtPayNow" runat="server">0</asp:TextBox>
                   </td>
                   <td style="text-align:right; width:180px;">Current Outstanding Balance:</td>
                   <td style="text-align:left; width:100px;">
                       <asp:TextBox ID="txtPayNo" runat="server" BackColor="#FFFFCC" ToolTip="Auto Calculation">0</asp:TextBox>
                   </td>
                   <td style="text-align:right; width:180px;">Settlement Account:</td>
                   <td style="text-align:left; width:200px;">
                       <asp:DropDownList ID="ddlBankList" runat="server"></asp:DropDownList>
                   </td>
                   <td style="text-align:right; width:180px;">Discount%:</td>
                   <td style="text-align:left; padding-right:30px; ">             
                       <asp:TextBox ID="txtDis" runat="server" Text="0"></asp:TextBox>
                   </td>
               </tr>
               <tr>
                   <td style="width:180px; text-align:right;">Logistics Company:</td>
                   <td style="text-align:left; width:100px;">
                       <asp:DropDownList ID="ddlSendCompanyList" runat="server"></asp:DropDownList>
                    </td>
                   <td style="text-align:right; width:180px;">Tracking Number:</td>
                   <td style="text-align:left; width:100px;">
                       <asp:TextBox ID="txtSendNumber" runat="server"></asp:TextBox>
                   </td>
                   <td style="text-align:right; width:180px;">Shipping Method:</td>
                   ...
                   <td style="text-align:right; width:180px;">Discount Amount:</td>
                   <td style="text-align:left; padding-right:30px; ">
                       <asp:TextBox ID="txtDisPrice" BackColor="#FFFFCC" ToolTip="Auto Calculation" Text="0" runat="server"></asp:TextBox>
                   </td>
               </tr>
               <tr>
                   <td style="width:180px; text-align:right;">Recipient:</td>
                   <td style="text-align:left; width:100px;">
                       <asp:TextBox ID="txtGetName" runat="server"></asp:TextBox>
                   </td>
                   <td style="text-align:right; width:180px;">Contact Number:</td>
                   <td style="text-align:left; width:100px;">
                       <asp:TextBox ID="txtPhone" runat="server"></asp:TextBox>
                   </td>
                   <td style="text-align:right; width:180px;">Delivery Address:</td>
                   <td style="text-align:left; ">
                       <asp:TextBox ID="txtAddress" runat="server"></asp:TextBox>
                   </td>
                   <td style="text-align:right; width:180px;">Shipping Fee:</td>
                   <td style="text-align:left; padding-right:30px; "> 
                       <asp:TextBox ID="txtSendPrice" runat="server" Text="0"></asp:TextBox>
                   </td>
                   </tr>
               <tr>
                   <td style="width:180px; text-align:right;">Remarks:</td>
