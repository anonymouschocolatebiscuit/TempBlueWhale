...
$(function () {
    ...
    function keyDownSearch(e) {
        ...
        if (code == 13) {
            ...
            if (txtKeys != "" && txtKeys != "Please use a scanner or enter and press Enter...") {
                ...
                $.ajax({
                    ...
                    success: function (resultList) {
                        ...
                        if (resultList == "Login timed out!") {
                            alert(resultList, 'Tips');
                            $("#txtKeys").val("");
                            return;
                        }

                        if (resultList == "No such product!") {
                            alert(resultList, 'Tips');
                            $("#txtKeys").val("");
                            return;
                        }
                        ...
                        if (dataList.length > 1) {
                            alert("This code has " + dataList.length + " product information entries. Please select manually!", 'Information Prompt');
                            $("#txtKeys").val("");
                            return;
                    ...
                    error: function (msg) {
                        ...
                        $.ligerDialog.alert("Network abnormality, please contact the administrator", 'Tips');
                    }
                });
            }
...
function addNewRowSearch(e) {
    ...
    manager.addRow({
        ...
        tax: 0,
        priceTax: e[0].priceSalesRetail, //Unit price including tax
...
function save() {
    ...
    var bkId = $("#ddlBankList").val(); //Get the Value selected by Select
