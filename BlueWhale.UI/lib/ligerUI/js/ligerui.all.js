            ...
            if (p.condition)
            {
                ...
                $("div", containerBtn1).ligerButton({
                    ...
                    click: function ()
                    {
                       ...
                       // alert(grid.conditionParmName || 'condition'+"=" +$.ligerui.toJSON(rules));
...
(function ($)
{
    ...
    $.ligerDefaults.GridString = {
        errorMessage: 'Error',
        pageStatMessage: 'Displaying from {from} to {to}, total {total} records. Records per page: {pagesize}',
        pageTextMessage: 'Page',
        loadingMessage: 'Loading...',
        findTextMessage: 'Search',
        noRecordMessage: 'No data',
        isContinueByDataChanged: 'Data changed, continue will lose data, confirm to proceed?',
        cancelMessage: 'Cancel',
        saveMessage: 'Save',
        applyMessage: 'Apply',
        draggingMessage: '{count} row'
    };
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        addRow: function (rowdata, neardata, isBefore, parentRowData)
        {
            ...
            g.trigger('afterAddRow', [rowdata]);//石猛修改
            return rowdata;
        },
...
(function ($)
{
    ...
    $.ligerMessageBox.confirm = function (title, content, callback)
    {
        ...
        p = {
            ...
            title: title,
            content: content,
            buttons: [{ text: 'Yes', onclick: onclick }, { text: 'No', onclick: onclick}]
        };
        return $.ligerMessageBox(p);
    };
    ...
    $.ligerui.getPopupFn = function (p)
    {
        ...
        function show()
        {
            ...
            win = $.ligerDialog.open({
                ...
                buttons: [
                 { text: 'Confirm', onclick: function (item, dialog) { toSelect(); dialog.hide(); } },
...
(function ($)
{
    ...
    $.ligerDefaults.TabString = {
        closeMessage: "Close Current Tab",
        closeOtherMessage: "Close Other Tab",
        closeAllMessage: "Close All Tab",
