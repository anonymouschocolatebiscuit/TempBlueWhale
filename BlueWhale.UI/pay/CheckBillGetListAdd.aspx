        ...
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
                ...
                <td style="text-align:left;" colspan="6">
                    <table id="Table2" border="0" cellpadding="0" cellspacing="0" style="line-height:40px;">
                        <tr>
                            ...
                            <td style="text-align:center; width:30px; padding-left: 10px;">To</td>
                            <td style="text-align:left; width:120px">
            ...
            <tr>
                ...
                <td style="text-align:left;">
                    <input id="Button1" class="ui-btn ui-btn-sp mrb" type="button" value="Add" style="margin-left:10px;" onclick="save()" />
                </td>
            </tr>
        </table>
    </form>
