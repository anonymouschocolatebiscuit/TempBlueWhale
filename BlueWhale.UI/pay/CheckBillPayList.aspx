<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckBillPayList.aspx.cs" Inherits="BlueWhale.UI.pay.CheckBillPayList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Payment Settlement - View</title>
    ...
    <script src="js/CheckBillPayList.js" type="text/javascript"></script>
        ...
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:98%; line-height:40px;">
            <tr>
                ...
                <td style="text-align:left; width:180px;">
                    <asp:TextBox ID="txtKeys" runat="server" CssClass="ellipsis-input" nullText="Please Enter Receipt No./Supplier/Remark"></asp:TextBox>
                </td>
