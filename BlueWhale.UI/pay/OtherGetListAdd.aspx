<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherGetListAdd.aspx.cs" Inherits="BlueWhale.UI.pay.OtherGetListAdd" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add New Other Payment</title>
    ...
    <script src="js/OtherGetListAdd.js" type="text/javascript"></script>
</head>
...
<body style="padding-top:10px; padding-left:10px;">
    <form id="form1" runat="server">
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
            <tr>
                <td style="width:90px; text-align:right;">Contact Unit：</td>
