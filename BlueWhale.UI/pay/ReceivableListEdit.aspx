...
<body style="padding-top: 10px; padding-left: 10px;">
    <form id="form1" runat="server">
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width: 99%; line-height: 40px;">
            <tr>
                <td style="width: 80px;">Sales unit：</td>
                <td style="text-align: left; width: 250px;">
                    <asp:DropDownList ID="ddlVenderList" runat="server" Width="250px">
                    </asp:DropDownList>
                </td>
                <td style="width: 120px; padding-left: 30px;">Payment Date：</td>
            ...
            <tr>
                <td style="width: 120px;">Overall Discount：</td>
                <td style="text-align: left; width: 260px;">
                    <asp:TextBox ID="txtDisPrice" runat="server">0</asp:TextBox>
                </td>
                <td style="width: 250px; padding-left: 30px;" colspan="2">Advance Payment Received This Time：</td>
                <td style="text-align: left; width: 180px;">
