<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherPayList.aspx.cs" Inherits="BlueWhale.UI.pay.OtherPayList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>Other Payment Search</title>
    ...
    <body style="padding-left: 10px; padding-top: 10px;">
        <form id="form1" runat="server">
            <table id="form" border="0" cellpadding="0" cellspacing="0" style="width: 98%; line-height: 40px;">
                <tr>
                    <td style="text-align: right; width: 60px; padding-right: 0.25rem;">Keyword：</td>
                    <td style="text-align: left; width: 180px;">
                        <asp:TextBox ID="txtKeys" runat="server" CssClass="ellipsis-input" placeholder="Doc No./Supplier/Remarks"></asp:TextBox>
                    </td>
                    <td style="text-align: right; width: 80px; padding-right: 0.25rem;">Start Date：</td>
                    <td style="text-align: left; width: 120px;">
                        <asp:TextBox ID="txtDateStart" runat="server" ltype="date" validate="{required:true}"></asp:TextBox>
                    </td>
                    <td style="text-align: right; width: 80px; padding-right: 0.25rem;">End Date：</td>
