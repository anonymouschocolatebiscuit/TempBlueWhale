<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayMentList.aspx.cs" Inherits="BlueWhale.UI.pay.PayMentList" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">

<head runat="server">
    <title>Purchase Payment Inquiry</title>
    ...
    <script src="js/PayMentList.js" type="text/javascript"></script>
...
<body style="padding-left:10px; padding-top:10px;">
    <form id="form1" runat="server">
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99.6%; line-height:40px;">
            <tr>
                ...
                <td style="text-align:right; width:80px; padding-right: 0.5rem;">End Date:</td>
            ...
            <tr>
                <td style="text-align:left; height:300px; white-space: nowrap;" colspan="8">
                    <div id="maingrid"></div>
