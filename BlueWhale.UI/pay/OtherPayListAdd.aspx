<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherPayListAdd.aspx.cs" Inherits="BlueWhale.UI.pay.OtherPayListAdd" %>
...
<head runat="server">
    ...
    <script src="js/OtherPayListAdd.js" type="text/javascript"></script>
</head>
<body style="padding-top: 10px; padding-left: 10px;">
    <form id="form1" runat="server">
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="line-height: 40px;">
            <tr>
                <td style="width: 140px; text-align: right; padding-right: 0.5rem;">Business Counterpart: </td>
