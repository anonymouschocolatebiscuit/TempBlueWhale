<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayMentListEdit.aspx.cs" Inherits="BlueWhale.UI.pay.PayMentListEdit" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <head runat="server">
        <title>Sales Payment - Create</title>
       <link href="../lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
        <link href="../lib/ligerUI/skins/Gray2014/css/all.css" rel="stylesheet" type="text/css" />
        <script src="../lib/jquery/jquery-1.3.2.min.js" type="text/javascript"></script>
        <script src="../lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script>
        <script src="../lib/json2.js" type="text/javascript"></script>
         <script src="js/PayMentListEdit.js" type="text/javascript"></script>
    </head>
        ...
        <form id="form1" runat="server">
            <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
               <tr>
                   ...
                   <td style="text-align:right; width:120px; padding-right:0.5rem;"> Collection Date: </td>
               ...
               <tr>
                    <td align="left" colspan="6">
                       <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="line-height:40px;">
                           <tr>
                               <td style="text-align:right; width:140px; padding-right:0.5rem;"> Source Order Number: </td>
                               ...
                               <td style="text-align:left;">
                                   <input id="btnSelectBill" type="button" value="Search" class="ui-btn" onclick="selectBill()" />
                               </td>
                           </tr>
                       </table>
                   </td>
               ...
               <tr>
                   <td align="right" style="width: 110px; padding-right:0.5rem;">
                       Overall Discount: </td>
                   <td style="text-align:left; width:250px;">
                    <asp:TextBox ID="txtDisPrice" runat="server">0</asp:TextBox>
                   </td>
                   <td style="text-align:right; width:120px; padding-right:0.5rem;"> Advanced Payment: </td>
                   <td style="text-align:left; width:180px;">
                    <asp:TextBox ID="txtPayPriceNowMore" runat="server" BackColor="#FFFFCC" ToolTip="Auto Calculation">0</asp:TextBox>
                   </td>
                   <td style="text-align:right; width:80px;"> &nbsp;</td>
                   <td style="text-align:left;"> &nbsp;</td>
               </tr>
               <tr>
                   <td align="right" style="padding-right:0.5rem;"> 
                       Remarks: 
                   </td>
