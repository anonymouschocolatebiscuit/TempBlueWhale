            ...
            <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:100%; line-height:40px;">
                <tr>
                    ...
                    <td style="text-align:center; width:220px;">
                        <asp:TextBox ID="txtKeys" runat="server" placeholder="Receipt No./Customer/Remark"></asp:TextBox>
                    </td>
                    <td style="text-align:left; width:70px;">Start Date: </td>
                    <td style="text-align:center; width:220px;">
                        <asp:TextBox ID="txtDateStart" runat="server" ltype="date" validate="{required:true}"></asp:TextBox>
                    </td>
                    <td style="text-align:left; width:70px;">End Date: </td>
                    <td style="text-align:center; width:220px;">
