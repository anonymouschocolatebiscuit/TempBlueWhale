...
namespace BlueWhale.UI.pay.ashx
{
    ...
    public class CheckBillGetListEdit : IHttpHandler, IRequiresSessionState  // Using Session requires referencing IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (pId > 0)
            {
                ...
                if (check > 0)
                {
                    ...
                    logs.Events = "Modified Collection Verification Order: " + obj.Id.ToString();
