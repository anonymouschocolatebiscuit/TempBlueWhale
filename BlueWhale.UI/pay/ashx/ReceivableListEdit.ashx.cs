...
{
    /// <summary>
    /// Description of ReceivableListEdit
    /// </summary>
    public class ReceivableListEdit : IHttpHandler, IRequiresSessionState  //Session must reference IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!basePage.CheckPower("ReceivableListEdit"))
            {
            ...
            dal.Flag = "Save";
            dal.OrderNumber = "";//Data is not required here for processing payment information from the order system
