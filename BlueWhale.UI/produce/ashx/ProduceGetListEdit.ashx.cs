...
{
    /// <summary>
    /// Summary description for ProduceGetListEdit
    /// </summary>
    public class ProduceGetListEdit : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (context.Session["userInfo"] == null)
            {
                ...
                context.Response.Write("Login timed out, please re-login and try again!");
                return;
            ...
            #region Assign Primary Table Value
            ...
            if (pId)
            {
                ...
                #region Produce Section

                DAL.produce.ProduceGetListItem itemDAL = new DAL.produce.ProduceGetListItem();
                Model.produce.ProduceGetListItemModel item = new Model.produce.ProduceGetListItemModel();
                ...
                logs.Events = "Edit production material requisition：" + model.number;
