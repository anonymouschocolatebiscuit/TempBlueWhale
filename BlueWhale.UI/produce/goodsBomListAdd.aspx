        ...
        <form id="form1" runat="server">
            <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
                ...
                <tr>
                    ...
                    <td style="text-align:right; width:80px;padding-right:5px">Specification :</td>
                    <td style="text-align:left; width:180px;">
                ...
                <tr>
                    ...
                    <td style="text-align:right; width:80px;padding-right:5px">Yield Rate(%) :</td>
                    <td style="text-align:left; width:180px;">
                        <asp:TextBox ID="txtRate" runat="server" Text="100"></asp:TextBox>
                    </td>
                    <td style="text-align:right; width:80px;padding-right:5px"></td>
