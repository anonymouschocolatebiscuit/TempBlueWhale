<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="produceInList.aspx.cs" Inherits="BlueWhale.UI.produce.produceInList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Production Warehouse Entry</title>
    ...
    <script src="js/produceInList.js" type="text/javascript"></script>
</head>
        ...
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width: 100%; line-height: 40px;">
            <tr>
                ...
                <td style="text-align: right; padding-right: 20px;">
                    ...
                    <input id="btnCheckNo" type="button" value="FailCheck" class="ui-btn" onclick="checkNoRow()" />
