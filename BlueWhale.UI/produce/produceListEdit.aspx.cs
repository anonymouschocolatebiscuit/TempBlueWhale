...
namespace BlueWhale.UI.produce
{
    public partial class produceListEdit : BasePage
    {
        ...
        /// <summary>
        /// Process、Keep for usage for future
        /// </summary>
        /// <param name="id"></param>
        ...
        void GetDataList(int id)
        {
            ...
            DAL.produce.ProduceListItemBomDAL itemDAL = new ProduceListItemBomDAL();
        ...
        void GetDataListBom(int goodsId, int numGoods)
        {
            ...
            DAL.produce.goodsBomListItem dal = new goodsBomListItem();
