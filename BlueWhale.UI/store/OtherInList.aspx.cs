...
{
    public partial class OtherInList : BasePage
    {
        ...
        void CheckRow(string id)
        {
            if (Session["userInfo"] != null)
            {
                ...
                if (num > 0)
                {
                    Response.Write("Successfully approved " + num + " records!");
                }
                else
                {
        ...
        void CheckNoRow(string id)
        {
            if (Session["userInfo"] != null)
            {
                ...
                if (num > 0)
                {
                    Response.Write("Successfully revoked approval for " + num + " records!");

                }
                else
                {
                    Response.Write("Revoke approval failed!");
                }
            }
            else
            {
