...
<body style="padding-top: 10px; padding-left: 10px;">
    <form id="form1" runat="server">
        <table id="form" border="0" cellpadding="0" cellspacing="0" style="width: 99%; line-height: 40px;">
            <tr>
                <td style="width: 120px; text-align: center;">Business Partner：</td>
                <td style="text-align: left; width: 240px;">
                    <asp:DropDownList ID="ddlVenderList" runat="server" Width="240px">
                    </asp:DropDownList>
                </td>
                ...
                <td style="text-align: right; width: 160px;">Warehouse Entry Type：</td>
