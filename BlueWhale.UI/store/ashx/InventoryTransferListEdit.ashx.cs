...
namespace BlueWhale.UI.store.ashx
{
    ...
    public class InventoryTransferListEdit : IHttpHandler, IRequiresSessionState 
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!basePage.CheckPower("InventoryTransferListEdit"))
            {
            ...
            if (pId > 0)
            {
                ...
                if (check > 0)
                {
                    ...
                    logs.Events = "Edit Inventory Transfer List：" + dal.Number;
