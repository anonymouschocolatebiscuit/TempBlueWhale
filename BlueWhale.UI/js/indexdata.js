...
[
        {
            text: 'Icon Analysis', isexpand: false, children: [
                { url: "deskView.aspx", text: "Management cockpit" }
	...
	{
            text: 'Analytical statistical reports', isexpand: false, children: [
         {
                    text: 'Procurement business report', isexpand: false, children: [
                        { url: "demos/form/v125/afterContent.htm", text: "PurOrder List Report" },
                { url: "demos/form/v125/afterContent.htm", text: "采购明细表" },
                { url: "demos/form/v125/enabled.htm", text: "采购汇总表-按商品" },
                 { url: "demos/form/v125/fieldError.htm", text: "PurchaseOrderSumGoods-ByVender" }
