        ...
        void GetDataList()
        {
            ...
            for (var i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                list.Add(new
                {
                    ...
                    yueDate = DateTime.Parse(ds.Tables[0].Rows[i]["yueDate"].ToString()).ToString("yyyy/MM/dd"),
                    ...
                    makeDate = DateTime.Parse(ds.Tables[0].Rows[i]["makeDate"].ToString()).ToString("yyyy/MM/dd"),
