    ...
    <script src="../lib/json2.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
        ...
        var form = $("#form").ligerForm();
            ...
            checkbox: true,
                columns: [
                 ...
                 { display: 'Id', name: 'id', id: 'id', width: 50, align: 'center' },
                 { display: 'Users', name: 'users', width: 280, type: 'int', align: 'left' },
                 { display: 'Event Contents', name: 'events', width: 370, align: 'left' },
                 { display: 'IP', name: 'ip', width: 170, align: 'center'},
                  { display: 'Date', name: 'date', width: 170, align: 'center' }
        ...
        function search() {
            ...
            if (keys == "Please enter user/event/IP address") {
...
<body style="padding-left:10px; padding-top:10px;">
    ...
    <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:100%; line-height:40px;">
           ...
           <td style="text-align:left; width:180px;">
               ...
               <asp:TextBox ID="txtKeys" runat="server" placeholder="Please enter user/event/IP address"></asp:TextBox>
           ...
           <td style="text-align:left;width:220px;">
               ...
               <input 
                   id="btnReload" class="ui-btn" type="button" value="Delete" onclick="deleteRow()" />
