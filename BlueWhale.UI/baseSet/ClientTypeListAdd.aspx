...
<body>
    <form id="form1" runat="server">
        <table id="form" border="0" cellpadding="0" cellspacing="10" style="width: 380px; line-height: 40px;">
            <tr>
                <td style="width: 142px; text-align: right; padding-right: 10px;">Category Name:</td>
                <td>
                    <asp:TextBox ID="txtNames" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 142px; text-align: right; padding-right: 10px;">Display Order:</td>
                <td>
