<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryListAdd.aspx.cs" Inherits="BlueWhale.UI.baseSet.InventoryListAdd" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
     <title>Inventroy Info</title>
...
<body>
    ...
    <tr>
    <td style="width:120px; text-align:right;">Inventory code:</td>
    <td>
    ...
    <tr>
    <td style="text-align:right;">Inventory name:</td>
    <td>
