<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsBrandListAdd.aspx.cs" Inherits="BlueWhale.UI.baseSet.GoodsBrandListAdd" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
    <head runat="server">
        <title>Product Brand Information</title>
    ...
    <body>
        <form id="form1" runat="server" style="display: flex; justify-content: center;">
            <table id="form" border="0" cellpadding="0" cellspacing="10" style="line-height:40px;">
                <tr>
                    <td style="width:100px; text-align:left;">Brand Name：</td>
                    <td>
                        <asp:TextBox ID="txtNames" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:left;">Display Order：</td>
                    <td>
