...
{
    public partial class PurReceiptList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Params["Action"] == "GetDataListSearch")
            {
                ...
                DateTime end = string.IsNullOrEmpty(Request.Params["end"].ToString()) ? DateTime.Today.AddDays(1).AddSeconds(-1) : Convert.ToDateTime(Request.Params["end"].ToString());
