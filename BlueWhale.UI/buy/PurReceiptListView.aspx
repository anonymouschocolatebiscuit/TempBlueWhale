<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurReceiptListView.aspx.cs" Inherits="BlueWhale.UI.buy.PurReceiptListView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Purchase Receipt Details</title>
            ...
            <tr>
                ...
                <td style="text-align:center; width:200px;">
                    <asp:TextBox ID="txtPayNo" runat="server" 
                        BackColor="#FFFFCC" ToolTip="Auto calculated">0</asp:TextBox>
                </td>
