...
$(function () {
    ...
    manager = $("#maingrid").ligerGrid({
        ...
        columns: [
            {
                display: 'Operation', isSort: false, width: 50, align: 'center', render: function (rowdata, rowindex, value) {
                    var h = "";
                    if (!rowdata._editing) {
            ...
            {
                display: 'Receipt Date', name: 'bizDate', width: 80, align: 'center', valign: 'center',
                totalSummary:
                {
                    type: 'count',
                    render: function (e) {
