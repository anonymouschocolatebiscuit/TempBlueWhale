...
$(function () {
    ...
    manager = $("#maingrid").ligerGrid({
        ...
        columns: [
            {
                display: 'Operate', isSort: false, width: 60, align: 'center', render: function (rowdata, rowindex, value) {
                    var h = "";
                    if (!rowdata._editing) {
            ...
            {
                display: 'Receipt Date', name: 'bizDate', width: 100, align: 'center', valign: 'center',
                totalSummary:
                {
                    type: 'count',
                    render: function (e) {
            ...
            { display: 'Document No.', name: 'number', width: 150, align: 'center' },
            {
                display: 'Business Type', name: 'types', width: 100, align: 'center',
                render: function (row) {
            ...
            {
                display: 'Purchase Quantity', name: 'sumNum', width: 130, align: 'right',
                totalSummary:
                {
                    align: 'right',
                    type: 'sum',
            ...
            { display: 'Buyer', name: 'bizName', width: 70, align: 'center' },
            { display: 'Approver', name: 'checkName', width: 80, align: 'center' },
...
function search() {
    ...
    if (keys == "Please enter document no./supplier/remarks") {
        keys = "";
    }
...
function checkRow() {
    ...
    if (!row) { $.ligerDialog.warn('Please select a row to operate'); return; }
