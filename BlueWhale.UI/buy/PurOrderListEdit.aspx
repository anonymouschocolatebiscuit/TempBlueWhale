<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurOrderListEdit.aspx.cs" Inherits="BlueWhale.UI.buy.PurOrderListEdit" %>
        ...
        <form id="form1" runat="server">
            <table id="form" border="0" cellpadding="0" cellspacing="0" style="width:99%; line-height:40px;">
                <tr>
                    ...
                    <td style="text-align:right; width:100px; padding-right:0.5rem;">Order Date: </td>
                    ...
                    <td style="text-align:left;">
                        <asp:DropDownList ID="ddlSalesPersonList" runat="server"></asp:DropDownList>
                    </td>
                </tr>
            </table>
