...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
     ...
     <script src="js/PurReceiptListAdd.js?ver<%=DateTime.Now.Ticks.ToString()%>" type="text/javascript"></script>
    <script src="../../lib/ligerUI/js/plugins/ligerDialog.js" type="text/javascript"></script>    </head>
        ...
        <form id="form1" runat="server">
            <table id="form" border="0" cellpadding="0" cellspacing="0" style="width: 99%; line-height: 40px;">
                <tr>
                    ...
                    <td style="text-align: center; width: 120px;">Stock In Date:</td>
                    <td style="text-align: center; width: 180px;">
                        <asp:TextBox ID="txtBizDate" runat="server" ltype="date" validate="{required:true}"></asp:TextBox>
                    </td>
                    <td style="text-align: center; width: 120px;">Purchaser:</td>
                    <td style="text-align: center; width: 180px;">
            ...
            <table id="tbFooter" border="0" cellpadding="0" cellspacing="0" style="width: 99%; line-height: 50px;">
                <tr>
                    <td style="text-align: left; width: 150px;">Current Payment:</td>
                    <td style="text-align: center; width: 100px;">
                        <asp:TextBox ID="txtPayNow" runat="server">0</asp:TextBox>
                    </td>
                    <td style="text-align: center; width: 150px;">Current Debt:</td>
                    <td style="text-align: center; width: 100px;">
                        <asp:TextBox ID="txtPayNo" runat="server" BackColor="#FFFFCC" ToolTip="Auto Calculation">0</asp:TextBox>
                    </td>
                    <td style="text-align: center; width: 150px;">Settlement Account:</td>
